...
#create database
conn = sqlite3.connect('climate_data.sqlite3')
...
# # example
# mylist = ['wash the SAAB', 'Take the garbage', 'cook the food']
...
def usa_temps():
    return render_template('index.html', myscript=myscript)
...
def temproute():
    ...
    # select *
    cursor.execute("select * from geo_states")
    ...
    return render_template('temproute.html', records=my_obj_data)
